...
projects through DevSpace Local Artifacts.
...
- ngrok or another user-controlled tunnel when the MCP host is remote

The server does not create the public tunnel for you. Use ngrok, Cloudflare
Tunnel, Pinggy, Tailscale Funnel, or your own HTTPS reverse proxy. See
[Dependencies and ngrok](dependencies.md) for the Windows installer.
